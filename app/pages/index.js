...
const Home = () => {
    const { initialized, initializeUser, loading, transactionPending, completedTodos, incompleteTodos, addTodo, removeTodo, deleteTodo, input,  handleChange, markTodo } = useTodo()
